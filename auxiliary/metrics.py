...
class InceptionV3(nn.Module):
    ...
    def __init__(self,
        ...
        inception = tvmodels.inception_v3(pretrained=True)
...
if __name__ == "__main__":
    ...
    fake_imgs_unorm = (fake_imgs * 0.5) + 0.5

    print("No normalize:", FID(real_imgs, fake_imgs_unorm))

    real_imgs_norm = (real_imgs - 0.5) / 0.5
